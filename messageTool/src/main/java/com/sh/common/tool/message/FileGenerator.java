...
import com.sh.common.tool.message.config.FileConfig;
import com.sh.common.tool.message.config.MessageConfig;
import com.sh.common.tool.message.config.MessageDirection;
