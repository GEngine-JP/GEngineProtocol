...
public class LunarCalendarUtil {
    ...
    private static String[] monthString={"一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","冬月","腊月"};
    private static String[] dayString = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十", "二十一", "二十二", "二十三", "二十四", "二十五", "二十六", "二十七", "二十八", "二十九", "三十", "三十一"};
    private static String[] weekString={"周日","周一","周二","周三","周四","周五","周六"};
    ...
    public static String solarToLunar() {
        Calendar calendar = Calendar.getInstance();
        int year = calendar.get(Calendar.YEAR);
        int month = calendar.get(Calendar.MONTH);
        int day = calendar.get(Calendar.DAY_OF_MONTH);
        int week = calendar.get(Calendar.DAY_OF_WEEK);
        int[] ints = solarToLunar(year, month, day);
        String monthStr = monthString[ints[1]];
        String dayStr = dayString[ints[2]];
        String weekStr = weekString[week-1];
        return "农历  "+monthStr + dayStr + "  " + weekStr;
    }
